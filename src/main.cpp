...
// Copyright (c) 2014 IlluminatiCoin developers
...
const string strMessageMagic = "IlluminatiCoin Signed Message:\n";
...
static const int64 nStartSubsidy = 20 * COIN;
...
{
        static const int64 BlocksTargetSpacing = 5; // 5 seconds
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("IlluminatiCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("IlluminatiCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("IlluminatiCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running IlluminatiCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("IlluminatiCoinMiner terminated\n");
        throw;
    }
}
