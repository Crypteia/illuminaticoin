    ...
    prevBlocks(0)
{
    ...
    if (!fIsTestnet)
    {
        setWindowTitle(tr("IlluminatiCoin") + " - " + tr("Storage Reserves"));
        QApplication::setWindowIcon(QIcon(":icons/bitcoin"));
        setWindowIcon(QIcon(":icons/bitcoin"));
    }
    else
    {
        setWindowTitle(tr("IlluminatiCoin") + " - " + tr("") + " " + tr("[testnet]"));
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Transfer IlluminatiCoin"), this);
    sendCoinsAction->setStatusTip(tr("Transfer IlluminatiCoins to another Storage Reserves"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Collect IlluminatiCoin"), this);
    ...
    if (!fIsTestnet)
        ...
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About IlluminatiCoin"), this);
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    {
        trayIcon->setToolTip(tr("IlluminatiCoin client") + " " + tr("[testnet]"));
