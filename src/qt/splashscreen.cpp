    ...
    QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText2  = QChar(0xA9)+QString(" 2013 ") + QString(tr("The IlluminatiCoin Consortium"));
    //QString testnetAddText  = QString(tr("[testnet]")); // define text to place as single text object
    QString titleText       = ""; // cut of testnet, place it as single object further down
    QString versionText     = "";
    QString copyrightText   = "";
    QString copyrightText2  = "";
    QString testnetAddText  = ""; // define text to place as single text object
