...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LLL");
    case mBTC: return QString("mLLL");
    case uBTC: return QString::fromUtf8("µLLL");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("illuminaticoin (1 : 1)");
    case mBTC: return QString("milluminaticoin (1 / 1,000)");
    case uBTC: return QString("µilluminaticoin (1 / 1,000,000)");
    //case nBTC: return QString("Nanogramweight IlluminatiCoin (1 / 1,000,000,000) STILL IN RESEARCH PHASE");
    default: return QString("???");
    }
}
